...
![image](https://github.com/BerezkaVika/20IS3-3-practic/blob/master/screenshots/prac8_1.png)


#### Добавляем класс UserServiceTest и приводим конструктор класса к следующему виду:

![image](https://github.com/BerezkaVika/20IS3-3-practic/blob/master/screenshots/prac_9/2.png)


#### Подключение пакета Moq к проекту

![image](https://github.com/BerezkaVika/20IS3-3-practic/blob/master/screenshots/prac_9/3.png)
...
![image](https://github.com/BerezkaVika/20IS3-3-practic/blob/master/screenshots/prac_9/5.png)
...
![image](https://github.com/BerezkaVika/20IS3-3-practic/blob/master/screenshots/prac_9/6.png)


#### Результат прохождения тестов

![image](https://github.com/BerezkaVika/20IS3-3-practic/blob/master/screenshots/prac_9/7.png)


#### Переделываем тестовый метод

![image](https://github.com/BerezkaVika/20IS3-3-practic/blob/master/screenshots/prac_9/8.png)


#### Создаём метод, который будет выдавать комбинации с невалиднымиданными пользователей

![image](https://github.com/BerezkaVika/20IS3-3-practic/blob/master/screenshots/prac_9/9.png)

#### Прохождение тестов

![image](https://github.com/BerezkaVika/20IS3-3-practic/blob/master/screenshots/prac_9/10.png)

#### Метод проверки успешного задания пользователя

![image](https://github.com/BerezkaVika/20IS3-3-practic/blob/master/screenshots/prac_9/12.png)

#### Тестирование через dotnet-cli

![image](https://github.com/BerezkaVika/20IS3-3-practic/blob/master/screenshots/prac_9/11.png)

#### Таким образом, мы обеспечили проверку кода и на самом GitHub-репозитории.

![image](https://github.com/BerezkaVika/20IS3-3-practic/blob/master/screenshots/prac_9/13.png)
